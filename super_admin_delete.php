   ...
   <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#1da6cf;">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                 <a class="nav-link" href="super_admin.php">Back</a>
                </li>
            </ul>
          </div>
        </nav>    
<body class="text-center">
    <form action="deleteuser.php" class="form-signin" method="post">
      <h1 class="h3 mb-3 font-weight-normal" style="color:#080000;">Delete User</h1>
