   ...
   <nav class="navbar navbar-expand-md navbar-dark" style="background-color:#1da6cf;">
          ...
          <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                 <a class="nav-link" href="">Delete Document</a>
                </li>
                <li class="nav-item">
...
<body class="text-center">
    <form class="form-signin" action="delete_doc.php" method="post" enctype="multipart/form-data">
      <h1 class="h3 mb-3 font-weight-normal" style="color:#080000;">Delete Document</h1>
      ...
      <input type="text" id="name" name="docname" class="form-control" placeholder="Document Name" required="" autocomplete="off" onfocus="document.getElementById('message').style.display='none';">  
